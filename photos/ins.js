  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = res.length-1; j>=0; j--) {
          var data = res[j];
          var liTmpl = "";
          var src = 'http://olg4t9xt4.bkt.clouddn.com/' + data;
;
          var minSrc = src + '?imageView2/1/w/200/h/200/q/100&raw=true';
          var target = minSrc;
          src += '?imageView2/1/w/800/h/800/q/100&raw=true';
          var type = "image";

          ulTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope="" itemtype="http://schema.org/ImageObject">\
                ...
                <figcaption style="display:none" itemprop="caption description">' + "来自七牛" + '</figcaption>\
            </figure>';
